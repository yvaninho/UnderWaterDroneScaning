...
public class ScenarioInstanceBasicMovementDectection implements IScenarioInstance {

	@Override

	/*
	 * Ce scénariot met en scène un drone capable de détecter les artefact de son envinonnement 
	 * 4.3.2.3	Produire une capacité de détection pour le « sous marin »
	 * 
	 */
