...
public class EntityMouvementSequenceur_ExempleSauvegarde2 extends EntityMouvementSequenceur implements IMover {
 ...
 * */
	...
	public EntityMouvementSequenceur_ExempleSauvegarde2(String name, SimFeatures features) {
		super(name, features);
	}
	...
	protected void AfterActivate(IEntity sender, boolean starting) {
		...
		Post(new FinLinearPhase(0), d.add(LogicalDuration.ofSeconds(1)));
		// on le premier scan
	...
	public class ScanOcean extends SimEvent {
		...
		public void Process() {
			...
			int indexMin = 0, magnitudeMin = -1, magnitudeCourante = 0;
	...
	public class Plongee extends SimEvent {
		...
		public void Process() {
			...
			//rectilinearMover = new RectilinearMover(d, mv.getPosition(d), plongee, ini.getMaxLinearSpeed());
	...
	public class TrackTarget extends SimEvent {
		...
		public void Process() {
			...
			rectilinearMover = new RectilinearMover(d, mv.getPosition(d), target.getPosition().add(monPoint), vitesseSousleau);
			mv = rectilinearMover;
	...
	public class ClassifyTarget extends SimEvent {
		...
		public void Process() {
			...
			Logger.Information(Owner(), "Classify Target ", "Phase Classify Target");
			LogicalDateTime d = getCurrentLogicalDate();
			if (target != null) {
